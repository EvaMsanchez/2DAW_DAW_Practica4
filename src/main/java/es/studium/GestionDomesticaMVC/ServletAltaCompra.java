 ...
 */
@WebServlet("/ServletAltaCompra")
public class ServletAltaCompra extends HttpServlet 
{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		int resultado = modelo.altaCompra(fecha, importe, idTienda, idUsuario);
		
		if(resultado == 0)
		{
			 session.setAttribute("alta", true);
		}
		else
		{
			 session.setAttribute("alta", false);
		}
