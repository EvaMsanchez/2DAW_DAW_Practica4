 ...
 */
@WebServlet("/ServletBorrarCompra")
public class ServletBorrarCompra extends HttpServlet 
{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		int resultado = modelo.borrarCompra(idCompra);
		
		if(resultado == 0)
		{
			 session.setAttribute("borrado", true);
		}
		else
		{
			 session.setAttribute("borrado", false);
		}
